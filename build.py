...
EXPERIENCE = """
    ...
    <div class="entry">
      ...
      <div class="meta">2023 &ndash; present &middot; Advised by Professor Akwum Onwunta</div>
      <p>My research develops optimization methods with provable guarantees and applies them
      to inverse problems and imaging. Current work learns proximal operators with
      input-convex neural networks and connects them to Hamilton&ndash;Jacobi equations,
      giving a route to reconstruction that avoids solving an optimization problem at every
      query. Earlier work analysed momentum-based minimization of the Ginzburg&ndash;Landau
      functional on Euclidean spaces and graphs.</p>
    </div>

    <div class="entry">
      <span class="title">Research Visit &mdash; University of Utah</span>
      <div class="meta">May &ndash; July 2024 &middot; Salt Lake City, UT, USA</div>
    </div>

    <h3 class="section">Teaching</h3>

    <div class="entry">
      <span class="title">Graduate Teaching Assistant &mdash; Lehigh University</span>
      <div class="meta">Summer 2025 &middot; Computer Science and Engineering, PA, USA</div>
      <p>Optimization and Mathematical Foundations.</p>
    </div>

    <div class="entry">
      <span class="title">Assistant Lecturer &mdash; Dominion University Ibadan</span>
      <div class="meta">2022 &ndash; 2023 &middot; Faculty of Computing Science, Nigeria</div>
      <p>Mathematical Methods.</p>
    </div>

    <div class="entry">
      <span class="title">Teaching Assistant &mdash; Dominion University Ibadan</span>
      <div class="meta">2020 &ndash; 2021 &middot; Faculty of Computing Science, Nigeria</div>
      <p>Elementary Mathematics I&ndash;III.</p>
    </div>

    <h3 class="section">Leadership &amp; Service</h3>

    <div class="entry">
      <span class="title">President &mdash;
      <a href="https://www.linkedin.com/company/lehigh-informs-student-chapter/">Lehigh INFORMS
      Student Chapter</a></span>
      <div class="meta">2025 &ndash; 2026 &middot; ISE Department, Lehigh University</div>
      <p>Led chapter activities, organised professional development events for graduate
      students, and coordinated the officer team.</p>
    </div>

    <div class="entry">
      <span class="title">Vice President and Treasurer &mdash;
      <a href="https://www.linkedin.com/company/nigerian-club-lehigh-university/">Lehigh
      University Graduate Association of Nigerian Students</a></span>
      <div class="meta">2024 &ndash; 2026 &middot; Bethlehem, PA, USA</div>
    </div>

    <div class="entry">
      <span class="title">Welfare Officer and President &mdash; Mathematics Students
      Fellowship, LAUTECH</span>
      <div class="meta">2017 &ndash; 2019 &middot; Department of Mathematics, Nigeria</div>
    </div>

    <div class="entry">
      <span class="title">Director of Studies &mdash; Christ Apostolic Youth Fellowship,
      LAUTECH</span>
      <div class="meta">2017 &ndash; 2018 &middot; Nigeria</div>
    </div>

    <h3 class="section">Volunteering</h3>
    <ul class="plain">
      <li><span class="year">2024</span> Graduate International Student Orientation,
      Lehigh University, Bethlehem, PA, USA.</li>

      <li><span class="year">2022</span> AIMS Teacher Training Partnership Program,
      Kigali, Rwanda.</li>

      <li><span class="year">2016&ndash;19</span> Community development services and medical
      outreaches, CACYOF outreach programs, LAUTECH, Nigeria.</li>
    </ul>
"""
